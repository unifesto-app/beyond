  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 overflow-hidden">
        {/* Marquee Bar - Bottom */}
        <div className="absolute bottom-[15%] rotate-3 w-[120%] -left-[10%] bg-white py-3 md:py-4 border-y border-zinc-200 z-0 overflow-hidden shadow-sm">
          <div className="flex whitespace-nowrap animate-marquee-reverse">
            {marqueeTexts.map((text, i) => (
              <span 
                key={i} 
                className="text-sm md:text-base font-grandh tracking-[0.3em] mx-8"
                style={{
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 pb-16 text-center">
          <div className="space-y-5 md:space-y-6">
            {/* Main Headline */}
            <div>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-grandl tracking-tight flex flex-wrap justify-center items-center gap-x-3 md:gap-x-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-2">
              <a
                href="#get-started"
                className="group relative px-7 py-3.5 rounded-full font-medium text-base text-white overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl"
                style={{
                  background: "linear-gradient(135deg, #3491ff, #0062ff)",
                }}
              >
              ...
              <a
                href="#learn-more"
                className="px-7 py-3.5 rounded-full font-medium text-base text-zinc-900 border-2 border-zinc-300 hover:border-zinc-400 hover:bg-zinc-50 transition-all duration-300"
              >
                Learn More
              </a>
            </div>
            ...
            <div className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl mx-auto">
              <div className="space-y-0.5">
                ...
                <div className="text-xs text-zinc-600 font-medium">Learn & Launch</div>
              </div>
              ...
              <div className="space-y-0.5">
                ...
                <div className="text-xs text-zinc-600 font-medium">Hackathon & Pitch</div>
              </div>
              ...
              <div className="space-y-0.5">
                ...
                <div className="text-xs text-zinc-600 font-medium">Program Timeline</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="text-center mb-16">
            <h2 
              className="text-4xl md:text-5xl font-grandh mb-4"
              style={{
                background: "linear-gradient(135deg, #3491ff, #0062ff)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Hackathon Card */}
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-xl transition-shadow border border-zinc-200">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <h3 
                  className="text-2xl md:text-3xl font-grandh mb-2"
                  style={{
                    background: "linear-gradient(135deg, #3491ff, #0062ff)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                ...
                <p className="text-zinc-600 mb-6">Build real-world solutions</p>
              </div>
            </div>
            ...
            {[
              ...
              <div key={item.month} className="flex gap-6 group">
                ...
                <div className="flex-1 pb-8">
                  <div className="bg-gradient-to-br from-blue-50/30 to-purple-50/30 rounded-2xl p-6 border border-zinc-200 group-hover:border-blue-300 group-hover:shadow-md transition-all">
            ...
            <div className="flex gap-6 pt-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-zinc-600 mb-6">Launch your startup idea</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={award.title} className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow border border-zinc-200">
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
          <h2 className="text-4xl md:text-5xl font-grandh mb-6 text-zinc-900">
            Ready to Go <span
              style={{
                background: "linear-gradient(135deg, #3491ff, #0062ff)",
                WebkitBackgroundClip: "text",
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#get-started"
              className="group relative px-7 py-3 rounded-full font-medium text-lg text-white overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl"
              style={{
                background: "linear-gradient(135deg, #3491ff, #0062ff)",
              }}
            >
            ...
            <a
              href="/about"
              className="px-7 py-3 rounded-full font-medium text-lg text-zinc-900 border-2 border-zinc-300 hover:border-zinc-400 hover:bg-zinc-50 transition-all duration-300"
            >
              Learn More
            </a>
          </div>
